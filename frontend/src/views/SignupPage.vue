    ...
    <div class="min-h-screen bg-[#020817] flex items-center justify-center px-4">
      <div class="max-w-md w-full space-y-8 bg-[#1E293B] p-8 rounded-lg">
        <div class="text-center">
          ...
          <h2 class="mt-6 text-3xl font-bold text-white">Crie uma conta</h2>
        </div>
        <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
          <div class="space-y-4">
            <div>
              <label for="name" class="text-sm font-medium text-gray-300">Nome</label>
              <input
                id="name"
                v-model="name"
                type="text"
          ...
          <div class="text-center text-sm">
            <router-link to="/signin" class="text-[#3576DF] hover:text-[#285bb8]">
